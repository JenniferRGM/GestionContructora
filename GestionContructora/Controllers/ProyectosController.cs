...
namespace GestionContructora.Controllers
{
    public class ProyectosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProyectoID,CodigoProyecto,Nombre,FechaInicio,FechaFinalizacion")] Proyectos proyectos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProyectoID,CodigoProyecto,Nombre,FechaInicio,FechaFinalizacion")] Proyectos proyectos)
        {
            if (ModelState.IsValid)
            {
